...
* @returns {string}
*/
export function create_segwit_bond_spec(pubkey, bond_value_sat, bond_asset, lock_time_unix, reclaim_pubkey) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ptr1 = passStringToWasm0(bond_asset, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(reclaim_pubkey, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        wasm.create_segwit_bond_spec(retptr, ptr0, len0, bond_value_sat, ptr1, len1, lock_time_unix, ptr2, len2);
...
* @returns {string}
*/
export function bond_address(spec, network) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.bond_address(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
* @returns {any}
*/
export function create_bitcoin_utxo(tx, vout) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(tx, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.create_bitcoin_utxo(retptr, ptr0, len0, vout);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {any}
*/
export function create_elements_utxo(tx, vout) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(tx, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.create_elements_utxo(retptr, ptr0, len0, vout);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function create_burn_tx(bond_utxo, bond_tx, spec_base64, double_spend_utxo, double_spend_tx, tx1_hex, tx2_hex, fee_rate_sat_per_vkb, reward_address) {
    ...
    try {
        ...
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(double_spend_utxo, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(double_spend_tx, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passStringToWasm0(tx1_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len5 = WASM_VECTOR_LEN;
        const ptr6 = passStringToWasm0(tx2_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('doubletake_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
